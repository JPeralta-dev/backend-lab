...
const result1 = await client.query(`EXPLAIN (ANALYSE, BUFFERS ) SELECT * FROM transactions 
WHERE user_id = 10`)
...
EXPLAIN (ANALYSE, BUFFERS ) SELECT * FROM transactions 
...
const result3 = await client.query(`EXPLAIN (ANALYSE, BUFFERS ) SELECT * FROM transactions 
